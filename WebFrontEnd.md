...
Bu dokümanda, Süz-Geç web uygulamasının kullanıcı arayüzü (UI) ve kullanıcı deneyimi (UX) görev dağılımı listelenmektedir.

---

## Grup Üyelerinin Web Frontend Görevleri

1. [Berk'in Web Frontend Görevleri (Auth, Arama, Karşılaştırma, Ürün Detay)](Berk-Mutlu/Berk-Mutlu-Web-Frontend-Gorevleri.md)
2. [Berra'nın Web Frontend Görevleri (Fiyat/Stok Alarmları, Bildirimler, Fırsatlar)](Berra-Kırış/Berra-Kırış-Web-Frontend-Gorevleri.md)
3. [Eda'nın Web Frontend Görevleri (Listelerim, Koleksiyonlar, Ürün Yorumları)](Eda-Nur-Tarhan/Eda-Nur-Tarhan-Web-Frontend-Gorevleri.md)
